      ...
      <div className="container mx-auto px-4 py-4 max-w-8xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-gradient-to-br from-charcoal/80 to-charcoal/60 border border-purple-500/30 rounded-xl p-6 lg:p-8 text-center hover:border-purple-500/60 transition-all duration-300 backdrop-blur-sm h-full flex flex-col">
              <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-gradient-to-br from-purple-500/20 to-purple-600/20 border border-purple-500/40 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <svg className="w-7 h-7 text-purple-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-purple-300/80 text-base font-medium mb-3">
                + Custom iconography
              </p>
              <p className="text-off-white/70 text-base leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-gradient-to-br from-charcoal/80 to-charcoal/60 border border-cyan-500/30 rounded-xl p-6 lg:p-8 text-center hover:border-cyan-500/60 transition-all duration-300 backdrop-blur-sm h-full flex flex-col">
              <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-gradient-to-br from-cyan-500/20 to-cyan-600/20 border border-cyan-500/40 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <svg className="w-7 h-7 text-cyan-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="3" y="4" width="18" height="12" rx="2" stroke="currentColor" strokeWidth="2" fill="none"/>
              ...
              <p className="text-cyan-300/80 text-base font-medium mb-3">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-gradient-to-br from-charcoal/80 to-charcoal/60 border border-yellow-500/30 rounded-xl p-6 lg:p-8 text-center hover:border-yellow-500/60 transition-all duration-300 backdrop-blur-sm h-full flex flex-col">
              <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-gradient-to-br from-yellow-500/20 to-yellow-600/20 border border-yellow-500/40 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <svg className="w-7 h-7 text-yellow-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-yellow-300/80 text-base font-medium mb-3">
