    ...
    <div className="pt-20 min-h-screen bg-charcoal text-off-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-charcoal/80 to-charcoal/60 border border-off-white/20 rounded-xl p-4 hover:border-yellow-400/50 transition-all duration-300 backdrop-blur-sm">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-yellow-500/20 to-yellow-600/20 border border-yellow-400/40 flex items-center justify-center flex-shrink-0">
