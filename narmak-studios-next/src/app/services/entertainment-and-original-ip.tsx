    ...
    <div className="pt-20 min-h-screen bg-charcoal text-off-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-4 max-w-8xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-6">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-gradient-to-br from-charcoal/80 to-charcoal/60 border border-red-500/30 rounded-xl p-6 lg:p-8 text-center hover:border-red-500/60 transition-all duration-300 backdrop-blur-sm h-full flex flex-col">
              <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-gradient-to-br from-red-500/20 to-red-600/20 border border-red-500/40 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <svg className="w-7 h-7 text-red-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="container mx-auto px-4 py-8 max-w-8xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mb-6">
          {/* Monetized content */}
          <div className="bg-gradient-to-br from-charcoal/80 to-charcoal/60 border border-off-white/20 rounded-xl p-6 lg:p-8 hover:border-red-400/50 transition-all duration-300 backdrop-blur-sm">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-red-500/20 to-red-600/20 border border-red-400/40 flex items-center justify-center flex-shrink-0">
